                            ...
                            <Menu as="div" className="relative ml-3">
                                ...
                                >
                                    <MenuItem>
                                        <a
                                            href="#"
                                            className="block px-4 py-2 text-sm w-full text-center text-gray-700 data-focus:bg-gray-100 data-focus:outline-hidden"
                                        >
                                            Profile
                                        </a>
                                    </MenuItem>
                                    <MenuItem>
                                        <button
                                            ...
                                            className="block px-4 py-2 text-sm w-full text-gray-700 data-focus:bg-gray-100 data-focus:outline-hidden hover:cursor-pointer"
                                        >
                                            Sign out
                                        </button>
                                    </MenuItem>
